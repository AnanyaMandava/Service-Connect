...
React.useEffect(()=>{
    ...
    axios.get(`http://localhost:3001/all/getallspbookings/${serviceProviderId}`).then((res) => {
    let active=0;
    let upcoming=0;
    let completed=0;
    let total=0;
    ...
    setOverview({total:total,active:active,upcoming:upcoming,completed:completed});
  })
},[])
      ...
      <Card component="li" sx={{ minWidth: 300, flexGrow: 1 }}>
        ...
        <CardContent sx={{ marginTop:"35px" }}>
          <Typography
            ...
            fontSize="30px"
          >
            Upcoming  <br></br> {overview && overview.upcoming}
          </Typography>
        </CardContent>
      </Card>
      <Card component="li" sx={{ minWidth: 300, flexGrow: 1 }}>
        ...
        <CardContent sx={{ marginTop:"35px" }}>
          <Typography
            ...
            fontSize="30px"
          >
            Completed  <br></br> {overview && (overview.completed)}
          </Typography>
        </CardContent>
      </Card>
