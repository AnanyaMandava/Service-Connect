...
export default function Chips() {
    ...
    const formatDate = (dateString) => {
      ...
      return date.toLocaleString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric', hour: '2-digit', minute: '2-digit', hour12: true }) ; // Converts to local timezone and formats as string
    };
    ...
    return (
      ...
      <AspectRatio ratio="1" sx={{ width: 290 }}>
        <img
        ...
        />
            ...
            <div>
                ...
                >
                    <b>{nextBooking ? formatDate(nextBooking.bookingDate) : "N/A" }</b>
                    
                </Chip>
                <Typography fontSize="sm" aria-describedby="card-description" mb={1}>
                    <br />
                    <b>Service</b>: {nextBooking ? nextBooking.service.serviceName : "N/A"}
                    <br />
                    <b>Type</b>: {nextBooking ? nextBooking.serviceType.serviceType : "N/A"}
                    <br />
                    <b>Customer</b>: {nextBooking ? nextBooking.user.fullname : "N/A"}
                    <br />
                    <b>Mobile</b>: +1 {nextBooking ? nextBooking.user.mobile : "N/A"}
                    <br />
                    <b>Address</b>: {nextBooking ? nextBooking.user.address : "N/A"}, {nextBooking ? nextBooking.user.city : "N/A"}, {nextBooking ? nextBooking.user.state : "N/A"}, {nextBooking ? nextBooking.user.zipcode : "N/A"}
                </Typography>
            </div>
        </Card>
    );
