...
export default function Chips() {
    ...
    useEffect(() => {
        ...
        axios.get(`${process.env.REACT_APP_F_URL}all/getnextbooking/${userId}`)
            .then(response => {
                if (response.data) {
        ...
        />
            ...
            <div>
                ...
                <Typography fontSize="sm" aria-describedby="card-description" mb={1}>
                    ...
                    <br />
                    <b>Service Provider</b>: {nextBooking ? nextBooking.serviceProvider.fullname : "N/A"}
                    <br />
                    <b>Mobile</b>: +1 {nextBooking ? nextBooking.serviceProvider.mobile : "N/A"}
                </Typography>
            </div>
        </Card>
    );
